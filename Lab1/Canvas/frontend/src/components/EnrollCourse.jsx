...
class EnrollCourse extends Component{
    constructor(props){
        ...
        this.state = {
            ...
            CourseName:"",
            errorMessage:"",
            searchResultData:JSON.parse(`[{"NAME":"Simon Shim","courseid":1,"coursecode":273,"coursename":"Enterprise Distributed System","coursedept":"CMPE","coursedescription":"Introduction to application protocols for large scale distributed systems including object request brokers, asynchronous messaging, and Web services. Lab is based on using protocols to build distributed systems. Prerequisites: Java programming or instructor consent. Computer Engineering and Software Engineering majors only. Corequisites: CMPE 272","courseroom":"ENG 189","coursecapacity":50,"waitlistcapacity":15,"courseterm":"FALL"},{"NAME":"Simon Shim","courseid":1,"coursecode":273,"coursename":"Enterprise Distributed System","coursedept":"CMPE","coursedescription":"Introduction to application protocols for large scale distributed systems including object request brokers, asynchronous messaging, and Web services. Lab is based on using protocols to build distributed systems. Prerequisites: Java programming or instructor consent. Computer Engineering and Software Engineering majors only. Corequisites: CMPE 272","courseroom":"ENG 189","coursecapacity":50,"waitlistcapacity":15,"courseterm":"SPRING"}]`),
            CurrentCourseInfo:{}
        }
    }
        ...
        axios.get(`${Config.BASE_URL}/searchCourse`, {params : { CourseTerm : this.state.CourseTerm, CourseCode:this.state.CourseCode, CourseName:this.state.CourseName, CourseDept:this.state.CourseDept}})
            .then(response => {
                if(response.data.success) {
                    ...
                    console.log(response.data.Courses);
                    this.setState = {
                        searchResultData:response.data.Courses
                    }
    ...
    enrollCourse = (Course, event) => {
        ...
        //let params = {StudentId : this.state.StudentId, CourseId: Course.CourseId, FacultyId:Course.FacultyId, CourseTerm:Course.CourseTerm};
        //console.log(`params`);
        //console.log(params);
        // axios.post(`${Config.BASE_URL}/enrollCourse`, params)
        //     .then(response => {
        //         console.log("Status Code : ",response.status);
        //         console.log(response.data);
        //         //iske response mei yeh aana chahiye ki waitlisted hai ya enrolled
        // });
    }
